...
//  my2048
//
//  Created by chasel on 2021/12/24.
//
...
struct Config {
    ...
    static let leftWaveY = UIScreen.main.bounds.height * 0.15
    static let rightWaveY = UIScreen.main.bounds.height * 0.85
...
struct SliderData {
    ...
    init(side: SliderSide) {
        self.init(side: side, centerY: Double(side == .left ? Config.leftWaveY : Config.rightWaveY), progress: 0)
    }
